...
def main():
    ...
    pdf.set_font("helvetica", "", 10)
    sitemap_text = (
        "The project maps 17 distinct pages covering the sitemap flow, organized by ID and navigation priority:\n\n"
        ...
        "3. article_template - Article Detail Template (Standard reading layout with hero, headers, TOC, upsells)\n"
        "4. listen - Listen Page (Podcast Hub featuring latest EP.07, hosts info, Shorts row, subscribe options)\n"
        "5. episode_template - Episode Detail Template (Individual episode detail, notes, transcript, related reads)\n"
        "6. gather - Gather Page (Events Hub with Knowledge Share session, Luma embed, past grid, city meetup form)\n"
        "7. tools - Tools & Downloads (Overview of downloadable checklists, guides, and playbooks)\n"
        "8. newsletter - Newsletter Landing (Hero headline centered, kit.com signup form, recent archive links)\n"
        "9. about - About Us (Origin story, founder letter, General Manager Ivona Namjesnik, agencies grid, stats)\n"
        "10. start_here - Start Here (Curated onboarding for first-time visitors featuring key reads, EP.07, and Foundation App)\n"
        "11. foundation - Foundation App Page (AI strategic positioning audit preview, tabbed sections)\n"
        "12. kb - Knowledge Base Page (Searchable AI answer-engine teaser pointing to kb.agencyhabits.com)\n"
        "13. bizdev_collection - Business Development Collection (Sub-page detailing the $599 resource and benefits)\n"
        "14. exit_checklist - Exit-Readiness Checklist (Sub-page with download form and alignment quote)\n"
        "15. goal_template - Annual Goal Setting Template (Sub-page with goal structure description)\n"
        "16. books - Book Recommendations (14 books filtered by Leadership, Finance, BD, Productivity; footer only)\n"
        "17. contact - Contact Us (Clickable categories FAQ accordion: General, Podcast, Partners, Selling; footer only)"
    )
